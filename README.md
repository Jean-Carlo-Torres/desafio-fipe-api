...
### ** Resultado final do desafio realizado **
```
Todos os veículos filtrados por ano: 
Veiculo[valor=R$ 253.844,00, marca=BMW, modelo=M3 Sedan 4.0 32V, ano=2012, tipoCombustivel=Gasolina]
Veiculo[valor=R$ 246.902,00, marca=BMW, modelo=M3 Sedan 4.0 32V, ano=2011, tipoCombustivel=Gasolina]
Veiculo[valor=R$ 221.239,00, marca=BMW, modelo=M3 Sedan 4.0 32V, ano=2010, tipoCombustivel=Gasolina]
Veiculo[valor=R$ 214.455,00, marca=BMW, modelo=M3 Sedan 4.0 32V, ano=2009, tipoCombustivel=Gasolina]
Veiculo[valor=R$ 144.931,00, marca=BMW, modelo=M3 Sedan 4.0 32V, ano=2008, tipoCombustivel=Gasolina]
```
